...
require('lazy').setup({
    ...
    },
    {
      ...
      opts = {
        ...
        tsserver_path = nil, -- Use default tsserver binary
      },
    },
...
vim.keymap.set('n', '<leader>sb', require 'telescope'.extensions.file_browser.file_browser, { noremap = true })
...
-- -- [[ Configure: lightbeam ]]
-- {
--   dir = "~/projects/lightbeam/lightbeam.nvim",
--   dependencies = {
--     "nvim-lua/plenary.nvim",
--   },
-- }
